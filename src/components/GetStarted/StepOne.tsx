...
export default function StepOne({ academicData, handleAcademicChange }: StepOneProps) {
  return (
    ...
    {/* University */}
        <div>
    <label className="block w-full text-xs sm:text-sm md:text-base font-bold text-gray-700 mb-1 flex flex-col sm:flex-row items-start sm:items-center mt-3 sm:mt-5 md:mt-6 gap-1 sm:gap-2">
      <GraduationCapIcon />
      University Name
    </label>
    <select
